var SLIDE_CONFIG = {
  // Slide settings
  settings: {
    title: 'A utilização de sistemas distribuídos no desenvolvimento </br> de material instrucional para a inclusão digital</br> do projeto Aedu-linux ',
